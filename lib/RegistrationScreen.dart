...
@override
  ...
  speak("Bienvenido a pantalla de registro, por favor seleccione una imagen con un rostro.");
}
             ...
             children: [
               ...
               ElevatedButton(
                   onPressed: () {
                     ...
                     speak("Rostro registrado exitosamente");
      ...
      body: Column(
        ...
        children: [
         ...
         :Container(
          ...
          //Seccion que muestra botones para elegir y capturarimagenes
          Container(
