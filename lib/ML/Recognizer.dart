  ...
  void loadRegisteredFaces() async {
   ...
   // debugPrint('query all rows:');
    ...
    //  debugPrint(row.toString());
      ...
      //obtener el valor de embedding como una cadena antes de convertirlo
      String embeddingStr = row[DatabaseHelper.columnEmbedding];
      print('Valor de embedding antes de procesae: $embeddingStr');


      //convertir la cadena a una lista de doubles
      List<double> embd =embeddingStr.split(',').map((e) {
        try {
          return double.parse(e);
        } catch (e){
          print('error al convertir "$e" a double');
          return 0.0;
        }
      }).toList();
      //imprimir la lista de doubles para verificar su contenido
      print('Embedding como lista de doubles: $embd');
      //Crear el objeto recognition y lo agrega al mapa
